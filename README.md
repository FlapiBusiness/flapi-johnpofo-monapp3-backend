# Flapi - johnpofo monapp3 - BackEnd
...
- Development-Remote : https://dev.mydomain.api.flapi.org
- Staging : https://staging.mydomain.api.flapi.org
- Production : https://mydomain.api.flapi.org
...
```bash
git clone git@github.com:FlapiBusiness/flapi-johnpofo-monapp3-backend.git
```
...
- Un fichier **`.env.keys.mydomain`** est fourni pour montrer la structure des clés, sans valeurs réelles.
